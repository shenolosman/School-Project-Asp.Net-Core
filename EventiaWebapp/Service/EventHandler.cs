    ...
    public class EventHandler
    {
        ...
        public EventHandler()
        {
            ...
            Attendees = new List<Attendee>()
            {
                ...
                new(){Id = 2,AttendeeName ="Osman",AttendeeEmail="osman@shenol.com",ListEvent=new List<Event>(),PhoneNummer="0721112244"},
            };           
